...
Question questions[] = {
    ...
    {"Qual e o elemento mais abundante na crosta terrestre?", {"Oxigenio", "Silicio", "Ferro", "Aluminio"}, 1},
    {"Qual e a montanha mais alta do mundo?", {"Monte Kilimanjaro", "Monte Everest", "Monte McKinley", "Monte Aconcagua"}, 1},
